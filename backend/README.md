...
## Project Structure
    ...
    ├── fragrant_cherry_dev_75765  # Django project configurations
...
1. Clone this repo and `cd fragrant_cherry_dev_75765`
...
2. Clone this repo and `cd fragrant_cherry_dev_75765`
